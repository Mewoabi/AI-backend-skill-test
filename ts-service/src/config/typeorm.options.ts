...
import { CreateDocumentsAndSummaries1720000000000 } from '../migrations/1720000000000-CreateDocumentsAndSummaries';
...
export const getTypeOrmOptions = (
  ...
  migrations: [InitialStarterEntities1710000000000, CreateDocumentsAndSummaries1720000000000],
